...
public class ORDSApiWithJsonPath extends HrTestBase {
    ...
    public void test1(){
        ...
        @Test
        public void test2(){
            // we added limit query param to get 107 emplyees
            ...
            List<String> employeesMakingMoreThan10000 = jsonPath.getList("items.findAll{it.salary>10000}.first_name");
            System.out.println(employeesMakingMoreThan10000);
